...
import obfsproxy.transports.salty_stream as salty_stream
...
transports = { 'dummy' : {'base': dummy.DummyTransport, 'client' : dummy.DummyClient, 'server' : dummy.DummyServer },
               ...
               'saltystream' : {'base': salty_stream.SaltyStreamTransport, 'client' : salty_stream.SaltyStreamClient, 'server' : salty_stream.SaltyStreamServer } }
